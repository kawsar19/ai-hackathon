    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 text-xs">Projects marked as completed</p>
        </div>
      </div>
          ...
          <div key={project.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-500">Completed on {new Date(project.updatedAt).toLocaleString()}</span>
              </div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
                <div className="h-2 rounded-full bg-green-600" style={{ width: `${project.progress}%` }} />
              </div>
              ...
              {(project.githubUrl || project.demoUrl || (project as any).documentationUrl || (project as any).videoUrl) && (
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  {project.demoUrl && (
                    <a href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-2.5 py-1.5 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
            ...
            <div className="mt-3">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Completed on {new Date(selectedProject.updatedAt).toLocaleString()}</p>
                </div>
